...
public class NathanGain extends Driver {
	...
	public void bindCommands() {
		...
		// D-Pad align
		RobotMap.HumanInput.Driver.xbox.dPad.up.whenPressed(
			new ChassisTurnAbsolute(RobotMap.Component.chassis, 180, RobotMap.Component.navx, RobotMap.Component.chassisMC));
		RobotMap.HumanInput.Driver.xbox.dPad.up.whenReleased(normalDrive);
		RobotMap.HumanInput.Driver.xbox.dPad.down.whenPressed(
			new ChassisTurnAbsolute(RobotMap.Component.chassis, 0, RobotMap.Component.navx, RobotMap.Component.chassisMC));
		RobotMap.HumanInput.Driver.xbox.dPad.down.whenReleased(normalDrive);
		RobotMap.HumanInput.Driver.xbox.dPad.left.whenPressed(
			new ChassisTurnAbsolute(RobotMap.Component.chassis, 270, RobotMap.Component.navx, RobotMap.Component.chassisMC));
		RobotMap.HumanInput.Driver.xbox.dPad.left.whenReleased(normalDrive);
		RobotMap.HumanInput.Driver.xbox.dPad.right.whenPressed(
			new ChassisTurnAbsolute(RobotMap.Component.chassis, 90, RobotMap.Component.navx, RobotMap.Component.chassisMC));
		RobotMap.HumanInput.Driver.xbox.dPad.right.whenReleased(normalDrive);
		// Auto drive 2 feet
		RobotMap.HumanInput.Driver.xbox.rb.whenPressed(new ChassisMoveDistance(RobotMap.Component.chassis, 800,
			RobotMap.Component.chassisEncoderMC, new KittenCommand("Drive Encoder Error", LogKitten.LEVEL_WTF),
			RobotMap.Component.leftEncoder, RobotMap.Component.rightEncoder));
		RobotMap.HumanInput.Driver.xbox.rb.whenReleased(normalDrive);
		RobotMap.HumanInput.Driver.xbox.lb.whenPressed(new ChassisMoveDistance(RobotMap.Component.chassis, -800,
			RobotMap.Component.chassisEncoderMC, new KittenCommand("Drive Encoder Error", LogKitten.LEVEL_WTF),
			RobotMap.Component.leftEncoder, RobotMap.Component.rightEncoder));
	...
	public double getTurnSpeed() {
		...
		double turnSpeed = scaleGain(rawTurnSpeed, RobotMap.Constant.HumanInput.TURN_GAIN,
			RobotMap.Constant.HumanInput.TURN_EXP) * RobotMap.Constant.HumanInput.TURN_SPEED_SCALE;
		return turnSpeed;
	}
}
