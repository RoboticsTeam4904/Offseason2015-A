...
public class NathanGain extends Driver {
	...
	public void bindCommands() {
		...
		// Auto drive 2 feet
		RobotMap.HumanInput.Driver.xbox.rb.whenPressed(new ChassisMotionProfileDistance(RobotMap.Component.chassis, 800, RobotMap.Component.chassisEncoderMC, RobotMap.Component.leftEncoder, RobotMap.Component.rightEncoder));
		RobotMap.HumanInput.Driver.xbox.rb.whenReleased(normalDrive);
		RobotMap.HumanInput.Driver.xbox.lb.whenPressed(new ChassisMotionProfileDistance(RobotMap.Component.chassis, -800, RobotMap.Component.chassisEncoderMC, RobotMap.Component.leftEncoder, RobotMap.Component.rightEncoder));
